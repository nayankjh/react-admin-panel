    ...
    <div className="App">
      ...
      <div id="info-wrapper">
        ...
        {activeRow && (
          <div id="info-content">
            <div>
              <b>User selected:</b> {activeRow.firstName} {activeRow.lastName}
            </div>
            <div>
              <b>Description: </b>
              <textarea
            ...
            <div>
              <b>Address:</b> {activeRow.address.streetAddress}
            </div>
            <div>
              <b>City:</b> {activeRow.address.city}
            </div>
            <div>
              <b>State:</b> {activeRow.address.state}
            </div>
            <div>
              <b>Zip:</b> {activeRow.address.zip}
            </div>
          </div>
        )}
      </div>
